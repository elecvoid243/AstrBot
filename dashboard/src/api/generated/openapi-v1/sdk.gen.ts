...
/**
 * Get the effective file access mode for a session
 */
export const getFileAccessMode = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetFileAccessModeData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetFileAccessModeResponse, GetFileAccessModeError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-access-mode'
    });
};

/**
 * Set the file access mode for a session
 */
export const setFileAccessMode = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetFileAccessModeData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetFileAccessModeResponse, SetFileAccessModeError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-access-mode'
    });
};
 ...
 */
export const setFileAccessRoots = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetFileAccessRootsData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetFileAccessRootsResponse, SetFileAccessRootsError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-access-mode/roots'
    });
};
...
/**
 * Archive multiple webchat sessions
 */
export const batchArchiveChatSessions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<BatchArchiveChatSessionsData, ThrowOnError>) => {
    return (options?.client ?? client).post<BatchArchiveChatSessionsResponse, BatchArchiveChatSessionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/batch-archive'
    });
};

/**
 * Restore multiple archived webchat sessions
 */
export const batchUnarchiveChatSessions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<BatchUnarchiveChatSessionsData, ThrowOnError>) => {
    return (options?.client ?? client).post<BatchUnarchiveChatSessionsResponse, BatchUnarchiveChatSessionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/batch-unarchive'
    });
};

/**
 * List archived webchat sessions
 */
export const listArchivedChatSessions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListArchivedChatSessionsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListArchivedChatSessionsResponse, ListArchivedChatSessionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/archived'
    });
};
 ...
 */
export const archiveChatSession = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ArchiveChatSessionData, ThrowOnError>) => {
    return (options?.client ?? client).post<ArchiveChatSessionResponse, ArchiveChatSessionError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/{session_id}/archive'
    });
};

/**
 * Restore an archived webchat session
 */
export const unarchiveChatSession = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UnarchiveChatSessionData, ThrowOnError>) => {
    return (options?.client ?? client).post<UnarchiveChatSessionResponse, UnarchiveChatSessionError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/{session_id}/unarchive'
    });
};
...
/**
 * Open a local file on the AstrBot host with the OS default application
 */
export const openChatLocalFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<OpenChatLocalFileData, ThrowOnError>) => {
    return (options?.client ?? client).post<OpenChatLocalFileResponse, OpenChatLocalFileError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/open-file'
    });
};

/**
 * Open the folder containing a local file on the AstrBot host
 */
export const openChatLocalFolder = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<OpenChatLocalFolderData, ThrowOnError>) => {
    return (options?.client ?? client).post<OpenChatLocalFolderResponse, OpenChatLocalFolderError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/open-folder'
    });
};
...
/**
 * Branch a webchat session from a bot message
 */
export const branchChatMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<BranchChatMessageData, ThrowOnError>) => {
    return (options?.client ?? client).post<BranchChatMessageResponse, BranchChatMessageError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/{session_id}/messages/{message_id}/branch'
    });
};
