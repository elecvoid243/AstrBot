...
def test_local_legacy_fields_are_fully_migrated():
    config = {
        ...
        "provider_settings": {
            ...
            "tool_call_timeout_exclude": ["wait_for_subagent", "special_tool"],
            "repeated_tool_call_notice": {"enable": False, "threshold": 5},
    ...
    assert config["agent_runner"] == {
        ...
        "config": {
            ...
            "misc": {
                ...
                "repeated_tool_call_notice": {"enable": True, "threshold": 3},
                "sanitize_context_by_modalities": True,
            },
        },
    }
